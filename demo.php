<?php
$file = simplexml_load_file("./data/currDataXml.xml");
$currFilename = "./data/currDataXml.xml";
$jsonFilename = "./data/currDataJson.json";
$currFile = file_get_contents($jsonFilename);
$countryFile = file_get_contents("./data/countries.json");
