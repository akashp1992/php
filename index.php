...
include './utils/currGet.php';
include './utils/currPost.php';
include './utils/currPut.php';
include './utils/currDelete.php';
include './utils/errorHandling.php';
$currFilename = "./utils/currDataXml.xml"; //defines the rates file
$mainErrorCounter = 0;
//defines method name
